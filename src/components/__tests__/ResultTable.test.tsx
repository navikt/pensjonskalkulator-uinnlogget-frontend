...
describe('ResultTable Component', () => {
  ...
  describe('Gitt at vi ikke har afpPrivat data', () => {
    test('Burde ikke tabellen vise AFP Privat', () => {
  ...
  describe('Gitt at vi har afpPrivat data', () => {
    test('Burde tabellen vise AFP Privat', () => {
      render(
        <FormContext.Provider value={mockContextValue}>
          <ResultTable simuleringsresultat={mockSimuleringsresultat} />
        </FormContext.Provider>
